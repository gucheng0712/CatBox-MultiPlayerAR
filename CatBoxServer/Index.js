...
app.get('/joined/:id/:team', function(req, res) {
    ...
    // Add the player Json Object into the playersThisRound Json Object
    // If the id number exist in the playersThisRound Json Object, then only update its team
...
function sortPlayerData() {
    ...
    var result = Object.keys(playersThisRound).map(function(key) {
        return {
            "id": Number(key),
            "score": playersThisRound[key].score,
            "team": playersThisRound[key].team
        };
    });
